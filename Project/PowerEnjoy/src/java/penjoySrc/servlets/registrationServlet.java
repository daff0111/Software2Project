...
public class registrationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(password == null || repeatPassword == null || password.compareTo(repeatPassword) != 0)
            {   
                out.println(password + repeatPassword + "Error! Passwords do not match <br>");
            }
            else
            {
                ...
                out.println("License: "+licenseNumber+"<br>");
                out.println("Payment: "+paymentInfo+"<br>");
                out.println("</body>");
                out.println("</html>");
            }
