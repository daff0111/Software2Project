...
\begin{itemize}
     ...
     \end{itemize}
\item A list with valid and invalid Reservations for the CRM Component. Also the list must test the following aspects of the system:
\begin{itemize}
     \item Null objects
     \item Null fields
     \item Available status of the CRM operator
...
\item A list with valid and invalid Rides for the User Report Controller. Also the list must test the following aspects of the system:
\begin{itemize}
     \item Null objects
     \item Null fields
     \end{itemize}
