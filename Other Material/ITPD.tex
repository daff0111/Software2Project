...
Our system will not handle adding or deleting Cars in the DB so these operations will not be integrated. Just operations that search or change the state of the Car.\par
...
\hline
	\textit{Input}& \textit{Response}\\ \hline
	Invalid or Null Parameters & false\\ \hline
	User has an Active Reservation & false, User can have only one reservation at a time\\ \hline
	Car Already Reserved & false, User should not be able to ask for a reserved Car\\ \hline
...
\hline
	\textit{Input}& \textit{Response}\\ \hline
	Invalid or Null Parameters & false\\ \hline
	Reservation not Active & false, User can only cancel an active reservation\\ \hline
...
\hline
	\textit{Input}& \textit{Response}\\ \hline
	Invalid or Null Parameters & false\\ \hline
	Reservation not Active & false, User can only confirm an active reservation\\ \hline
...
\hline
	\textit{Input}& \textit{Response}\\ \hline
	Invalid or Null Parameters & false\\ \hline
	Ride not Active & false, User can only end an active Ride\\ \hline
...
\item \textbf {Version 1.2:} 17/01/2017 - Minor Fixes on Controller Functions.
\end{itemize}
\end{document}
