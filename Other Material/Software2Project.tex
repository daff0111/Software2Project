...
\centering
\vspace*{\fill}
\noindent\makebox[\textwidth]{\includegraphics[width=0.3\textwidth]{1.png}}%
\caption {First screen of the app with the LogIn and SignIn options.}
\vspace*{0.5cm}
\end{figure}
\pagebreak
...
\centering
\vspace*{\fill}
\noindent\makebox[\textwidth]{\includegraphics[width=0.3\textwidth]{2.png}}%
\caption {Main page of the app where the user sees and selects the available cars.}
\vspace*{0.5cm}
\end{figure}
...
\centering
\vspace*{\fill}
\noindent\makebox[\textwidth]{\includegraphics[width=0.3\textwidth]{4.png}}%
\caption {Page to reserve a car that contais informations for the decision.}
\vspace*{0.5cm}
\end{figure}
\pagebreak
...
\centering
\vspace*{\fill}
\noindent\makebox[\textwidth]{\includegraphics[width=0.3\textwidth]{5.png}}%
\caption {Page to reserve a car that contais informations for the decision.}
\vspace*{0.5cm}
\end{figure}
\item \textbf{Ride Page:} 
\begin{figure}[h!]
\centering
\vspace*{\fill}
\noindent\makebox[\textwidth]{\includegraphics[width=0.4\textwidth]{3.png}}%
\caption {Page of the riding in the App.}
\vspace*{0.5cm}
\end{figure}
\pagebreak
\begin{figure}[h!]
...
\caption {Page of the riding in the Car screen.}
\vspace*{0.5cm}
\end{figure}
...
\end{figure}
\pagebreak
\item \textbf{Page of contact:} 
\begin{figure}[h!]
\centering
\vspace*{\fill}
\noindent\makebox[\textwidth]{\includegraphics[width=0.3\textwidth]{6.png}}%
\caption {Page where the user can contact the CRM operator.}
\vspace*{0.5cm}
\end{figure}
