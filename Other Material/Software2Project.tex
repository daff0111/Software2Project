...
\hline
	...
	\textbf{Exit conditions} &\parbox[t]{8cm}{ CRM operator analyses Francesco's request and apply or not changes is the system following these requests}\\ \hline
