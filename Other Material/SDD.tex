...
\begin{itemize}
	\item[-]SessionManager will answer for the Registration Request
	\item[-]UserController will add the User Account in the DB.
...
\begin{itemize}
	\item[-]SessionManager will allow the Login Request checking with the UserController for the correct credentials.
\end{itemize}
\item [G.3)]Users can save his/hers credentials in the System.
\begin{itemize}
	\item[-]UserComponent in the Client side can be set to send the LogIn request automatically to the SessionManager whenever the App is opened.
\end{itemize}
...
\begin{itemize}
	\item[-]SessionManager will answer the Search Car Request sending it to the CarController.
...
\begin{itemize}
	\item[-]SessionManager will control with the LocationHelper if the User and Car Location match.
...
\begin{itemize}
	\item[-]SessionManager will forward the Reservation Cancelation request to the ReservationController.
\end{itemize}
...
\begin{itemize}
	\item[-]SessionManager using the LocationHelper will request for Safe Parking Areas new the User.
\end{itemize}
...
\begin{itemize}
	\item[-]SessionManager will send the LogIn Request to the CRM Controller to check correct credentials.
\end{itemize}
